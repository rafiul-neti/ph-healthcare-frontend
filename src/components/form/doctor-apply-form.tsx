...
export default function DoctorApplyForm() {
  ...
  const { mutate: applyAsDoctor, isPending: applyPending } = useApplyAsDoctor();
        ...
        },
        {
          onSuccess: (res) => {
            ...
            toast.add({
              ...
              description: res.message || "Please verify your account.",
              type: "success",
            });
                ...
                <Field data-invalid={isInvalid}>
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    {file ? (
                      ...
                      <span className="text-xs text-muted-foreground">
                        Supported Files are .pdf, .doc, .docx, .png, .jpg, and
                        .jpeg and size {MAX_FILE_SIZE}MB.
                      </span>
                    )}
                  </div>
